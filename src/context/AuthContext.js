...
export const ROLE_PERMISSIONS = {
  admin: {
    label: 'Admin',
    pages: ['dashboard', 'incidents', 'clients', 'kanban', 'analytics', 'calendar', 'reports', 'settings'],
    canCreate: true,
    canEdit: true,
    canDelete: true,
    canExport: true,
  ...
  manager: {
    label: 'Yönetici',
    pages: ['dashboard', 'incidents', 'clients', 'kanban', 'analytics', 'calendar', 'reports'],
    canCreate: true,
    canEdit: true,
    canDelete: false,
    canExport: true,
  ...
  technician: {
    label: 'Teknisyen',
    pages: ['dashboard', 'incidents', 'calendar'],
    canCreate: false,
