        ...
        <div className="login-logo">
          <div className="login-logo-icon">
            <svg viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round">
              {/* π symbol */}
              <path d="M5 8h14" stroke="currentColor" strokeWidth="2.5"/>
              <path d="M9.5 8v10" stroke="currentColor" strokeWidth="2.5"/>
              <path d="M16 8v8c0 1.5-1.2 2.5-2.5 2.5" stroke="currentColor" strokeWidth="2.5"/>
              {/* circuit dots */}
